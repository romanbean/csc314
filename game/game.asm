...
%define BOLD_GREEN 27, "[32;1m"
%define BOLD_RED 27, "[31;1m"
%define END 27, "[0m"
...
segment .data
	...
	lives_fmt			db	BOLD_GREEN, "Lives: ", END , BOLD_RED, "%d" , END, 10, 13, 0
	lives				dd	4 ; 4 lives per player
...
asm_main:
	...
	game_loop:
		...
		jne		valid_move
			...
			mov		DWORD [ypos], edi
		valid_move:
		cmp 	BYTE [eax], ENEMY_CHAR
		jne		not_enemy
				sub		DWORD [lives], 1 ;; lose a live when a player cross with an enemy
